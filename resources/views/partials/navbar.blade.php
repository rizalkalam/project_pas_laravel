...
<nav class="navbar navbar-expand-lg navbar-light bg-white p-3 fixed-top shadow">
@else
<nav class="navbar navbar-expand-lg navbar-light bg-white p-3 fixed-top shadow">
@endif
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
            {{-- kondisi navbar dalam keranjang --}}
            @if (Route::is('keranjang'))
                ...
                @else
                  <li class="nav-item">
                    <a href="" class="nav-link"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
            ...
            @else
            {{-- akhir kondisi navbar dalam keranjang --}}
            <li class="nav-item">
            ...
            <li class="nav-item dropdown">
              ...
              @if (Auth::user()->hasRole('admin'))
              <li>
                <a class="dropdown-item nav-link" href="dashboard/home"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clipboard-data" viewBox="0 0 16 16">
