    ...
    <div class="card" style="width: 12rem;">
      ...
      <div class="d-grid gap-3 mb-3 d-md-flex justify-content-center">
        ...
        <form action="/beranda/delete/{{ $item->id }}" method="post">
          ...
          <button type="button" class="btn mt-2 w-auto bg-danger"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
